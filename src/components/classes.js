...
import { FaAppleAlt, FaBullhorn, FaHeartbeat, FaDumbbell, FaFire, FaTrophy } from 'react-icons/fa'

const Classes = props => {

  return (
    <div className="classes">
      <h2 data-sal="fade" data-sal-duration="1000" data-sal-easing="ease-in-out">PROGRAMS</h2>
      <div className="classes__content">
        ...
        <div data-sal="fade" data-sal-duration="1000" data-sal-easing="ease-in-out" className="classes__class">
          <div className="classes__content--5">
            ...
            <p>Compete with yourself and others to become the best version of yourself! Start with a benchmark workout and body scan and track your progress for 90 days. With support from coaches and fellow challenge participants, prepare to be amazed at how much progress you can make.</p>
          </div>
          <div className="classes__icon"><FaTrophy /></div>
        </div>
        <div data-sal="fade" data-sal-duration="1000" data-sal-easing="ease-in-out" className="classes__class">
